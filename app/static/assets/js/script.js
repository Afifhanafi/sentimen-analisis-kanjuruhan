                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <ul class="nav nav-tabs" id="myTab">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#Slangwords" class="nav-link" data-bs-toggle="tab">Normalisasi</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="#StopwordsRemoval" class="nav-link" data-bs-toggle="tab">Menghapus Kata <em>Stop</em></a>
                                                    </li>
                                                    <li class="nav-item">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <a class="btn btn-success" href="/preprocessing/dataset-sesudah-tragedi-kanjuruhan"><i class="fa-solid fa-arrow-left" style="margin-left:-0.3em;"></i> &nbsp;Kembali</a>
                                            </div>
